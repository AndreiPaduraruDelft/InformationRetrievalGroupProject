...
# INSTRUCTIONS = [
#     "Expand the query with 3 keywords only. Examples:\nQuery: machine learning -> deep learning, neural networks, AI\nQuery: climate change -> global warming, carbon emissions, sustainability\n\nKeywords for this query:",
# ]

INSTRUCTIONS = [
    "Expand the query with 5 keywords only. Do not add any extra text, just the keywords. Give me just one example."
]
